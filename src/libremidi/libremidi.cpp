...
#  include "detail/alsa.hpp"
#  include "detail/raw_alsa.hpp"
#endif

#if defined(LIBREMIDI_JACK)
#  include "detail/jack.hpp"
#endif

#if defined(LIBREMIDI_COREAUDIO)
#  include "detail/coreaudio.hpp"
#endif

#if defined(LIBREMIDI_WINMM)
#  include "detail/winmm.hpp"
#endif

#if defined(LIBREMIDI_WINUWP)
#  include "detail/winuwp.hpp"
#endif

#if defined(LIBREMIDI_EMSCRIPTEN)
#  include "detail/emscripten.hpp"
#endif

#if defined(LIBREMIDI_DUMMY)
#  include "detail/dummy.hpp"
#endif
